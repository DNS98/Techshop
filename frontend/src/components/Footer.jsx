    ...
    <Container as="footer" role="contentinfo" maxW='7xl'>
      ...
      >
        <Stack spacing={{ base: '6', md: '8' }} align="start">
          <Flex alignItems='center'>
            <Icon as={GiLaptop} h={10} w={10} color='orange.400' />
            <Text fontSize='2xl' fontWeight='extrabold' ml='7px'>Tech Shop</Text>
          </Flex>
          <Text color="muted">Cele mai bune preturi! </Text>
        </Stack>
        <Stack
      ...
      >
        <Text fontSize="sm" color="subtle">
          &copy; {new Date().getFullYear()} Tech Shop, Inc. All rights reserved.
        </Text>
